...
// used on production dyno on Heroku (own domain)
const char* rootCACertificate_DSTRootCAX3_HerokuCustomDoamin = \
"-----BEGIN CERTIFICATE-----\n" \
...
// used for non-production dynos on Heroku
const char* rootCACertificate_Digicert_HerokuDefaultDomain = \
"-----BEGIN CERTIFICATE-----\n" \
...
const char* rootCACertificate = rootCACertificate_Digicert_HerokuDefaultDomain;
...
void setup() {
  ...
  strcpy(plugs[0].name, "Plug 0");
  strcpy(plugs[0].devices[DEVICE_IDX_ORANGE].name,  "P0D0 (Or): %d");
  strcpy(plugs[0].devices[DEVICE_IDX_ORANGE].id,    "P0D0"); //"s0dryer");
  strcpy(plugs[0].devices[DEVICE_IDX_BROWN].name,   "P0D1 (Br): %d");
  strcpy(plugs[0].devices[DEVICE_IDX_BROWN].id,     "P0D1"); //"s0washer");
  strcpy(plugs[0].devices[DEVICE_IDX_BLUE].name,    "P0D2 (Bl): %d");
  strcpy(plugs[0].devices[DEVICE_IDX_BLUE].id,      "P0D2"); //"s0heatpump");
  strcpy(plugs[0].devices[DEVICE_IDX_GREEN].name,   "P0D3 (Gr): %d");
  strcpy(plugs[0].devices[DEVICE_IDX_GREEN].id,     "P0D3"); //"s0dishwasher");
  plugs[0].activeDevices = 4;

  strcpy(plugs[1].name, "Plug 1");
  ...
  strcpy(plugs[1].devices[DEVICE_IDX_BLUE].id,      "P1D2"); //"s0floorheat");
  strcpy(plugs[1].devices[DEVICE_IDX_GREEN].name,   "Gulvvame, bad  : %d");
  strcpy(plugs[1].devices[DEVICE_IDX_GREEN].id,     "P1D3"); //"s0floorheat");
